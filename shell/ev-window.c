...
static const GtkActionEntry entries[] = {
        ...
        /* File menu */
        { "FileOpen", "xapp-document-open-symbolic", N_("_Open…"),
                "<control>O",
        ...
        { "FileSaveAs", "xapp-document-save-as-symbolic", N_("_Save a Copy…"),
                "<control>S",
                N_("Save a copy of the current document"),
                G_CALLBACK (ev_window_cmd_save_as) },
        { "FilePrint", "xapp-document-print-symbolic", N_("_Print…"),
                "<control>P",
                N_("Print this document"),
                G_CALLBACK (ev_window_cmd_file_print) },
        { "FileProperties", "xapp-document-properties-symbolic", N_("P_roperties"),
                "<alt>Return",
                NULL,
        ...
        { "FileCloseWindow", "xapp-window-close-symbolic", N_("_Close"),
                "<control>W",
                NULL,
                G_CALLBACK (ev_window_cmd_file_close_window) },

        /* Edit menu */
        { "EditCopy", "xapp-edit-copy-symbolic", N_("_Copy"),
                "<control>C",
                NULL,
                G_CALLBACK (ev_window_cmd_edit_copy) },
        { "EditSelectAll", "xapp-edit-select-all-symbolic", N_("Select _All"),
                "<control>A",
                NULL,
                G_CALLBACK (ev_window_cmd_edit_select_all) },
        { "EditFind", "xapp-edit-find-symbolic", N_("_Find…"),
                "<control>F",
        ...
        { "EditRotateLeft", "xapp-object-rotate-left-symbolic", N_("Rotate _Left"),
                "<control>Left",
                NULL,
                G_CALLBACK (ev_window_cmd_edit_rotate_left) },
        { "EditRotateRight", "xapp-object-rotate-right-symbolic", N_("Rotate _Right"),
                "<control>Right",
                NULL,
        ...
        { "EditPreferences", "xapp-toolbox-symbolic", N_("Preferences"),
                "<shift><control>P",
                NULL,
        ...
        /* View menu */
        { "ViewZoomReset", "xapp-zoom-original-symbolic", N_("_Original size"),
                "<control>0",
                N_("View the document at its original size"),
                G_CALLBACK (ev_window_cmd_view_zoom_reset) },
        { "ViewZoomIn", "xapp-zoom-in-symbolic", N_("Zoom _In"),
                "<control>plus",
                N_("Enlarge the document"),
                G_CALLBACK (ev_window_cmd_view_zoom_in) },
        { "ViewZoomOut", "xapp-zoom-out-symbolic", N_("Zoom _Out"),
                "<control>minus",
                N_("Shrink the document"),
                G_CALLBACK (ev_window_cmd_view_zoom_out) },
        { "ViewReload", "xapp-view-refresh-symbolic", N_("_Reload"),
                "<control>R",
                N_("Reload the document"),
                G_CALLBACK (ev_window_cmd_view_reload) },
        { "ViewExpandWindow", "xapp-zoom-fit-best-symbolic", N_("_Expand Window to Fit"),
                "<control>e",
                N_("Expand Window to Fit"),
                G_CALLBACK (ev_window_cmd_view_expand_window) },

        { "ViewAutoscroll", "xapp-media-playback-start-symbolic", N_("Auto_scroll"),
                NULL,
                NULL,
                G_CALLBACK (ev_window_cmd_view_autoscroll) },

        /* Go menu */
        { "GoPreviousPage", "xapp-go-previous-symbolic", N_("_Previous Page"),
                "<control>Page_Up",
                N_("Go to the previous page"),
                G_CALLBACK (ev_window_cmd_go_previous_page) },
        { "GoNextPage", "xapp-go-next-symbolic", N_("_Next Page"),
                "<control>Page_Down",
                N_("Go to the next page"),
                G_CALLBACK (ev_window_cmd_go_next_page) },
        { "GoFirstPage", "xapp-go-first-symbolic", N_("_First Page"),
                "<control>Home",
                N_("Go to the first page"),
                G_CALLBACK (ev_window_cmd_go_first_page) },
        { "GoLastPage", "xapp-go-last-symbolic", N_("_Last Page"),
                "<control>End",
        ...
        /* Bookmarks menu */
        { "BookmarksAdd", "xapp-bookmark-new-symbolic", N_("_Add Bookmark"),
                "<control>D",
                N_("Add a bookmark for the current page"),
                G_CALLBACK (ev_window_cmd_bookmarks_add) },

        /* Help menu */
        { "HelpContents", "xapp-help-contents-symbolic", N_("_Contents"),
                "F1",
                NULL,
                G_CALLBACK (ev_window_cmd_help_contents) },

        { "HelpAbout", "xapp-help-about-symbolic", N_("_About"),
                NULL,
                NULL,
                G_CALLBACK (ev_window_cmd_help_about) },

        /* Toolbar-only */
        { "LeaveFullscreen", "xapp-view-restore-symbolic", N_("Leave Fullscreen"),
                NULL,
                N_("Leave fullscreen mode"),
                G_CALLBACK (ev_window_cmd_leave_fullscreen) },
        { "StartPresentation", "xapp-x-office-presentation-symbolic", N_("Start Presentation"),
                NULL,
...
static const GtkToggleActionEntry toggle_entries[] = {
        ...
        { "ViewSidebar", "xapp-view-left-pane-symbolic", N_("Side _Pane"),
                "F9",
...
static const GtkActionEntry view_popup_entries [] = {
	/* Links */
	{ "OpenLink", "xapp-document-open-symbolic", N_("_Open Link"), NULL,
	  NULL, G_CALLBACK (ev_view_popup_cmd_open_link) },
	{ "GoLink", "xapp-go-next-symbolic", N_("_Go To"), NULL,
	  NULL, G_CALLBACK (ev_view_popup_cmd_open_link) },
	...
	{ "RemoveAnnotation", "xapp-window-close-symbolic", N_("Remove Annotation"), NULL,
	  NULL, G_CALLBACK (ev_view_popup_cmd_remove_annotation) }
};

static const GtkActionEntry attachment_popup_entries [] = {
        { "OpenAttachment", "xapp-document-open-symbolic", N_("_Open Attachment"), NULL,
                NULL, G_CALLBACK (ev_attachment_popup_cmd_open_attachment) },
        { "SaveAttachmentAs", "xapp-document-save-as-symbolic", N_("_Save Attachment As…"), NULL,
