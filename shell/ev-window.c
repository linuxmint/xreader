...
static const GtkActionEntry entries[] = {
	...
	{ "FilePrint", "printer-symbolic", N_("_Print…"), "<control>P",
	...
	/* Bookmarks menu */
	{ "BookmarksAdd", "bookmark-add-symbolic", N_("_Add Bookmark"), "<control>D",
	  N_("Add a bookmark for the current page"),
	  G_CALLBACK (ev_window_cmd_bookmarks_add) },

	/* Help menu */
	{ "HelpContents", "help-browser-symbolic", N_("_Contents"), "F1", NULL,
	...
	{ "Escape", NULL, "", "Escape", "",
	  G_CALLBACK (ev_window_cmd_escape) },
        { "Slash", "edit-find-symbolic", NULL, "slash", NULL,
          G_CALLBACK (ev_window_cmd_edit_find) },
        { "F3", NULL, "", "F3", NULL,
          G_CALLBACK (ev_window_cmd_edit_find_next) },
        ...
        { "ShiftReturn", NULL, "", "<shift>Return", NULL,
          G_CALLBACK (ev_window_cmd_scroll_backward) },
	{ "p", "go-up-symbolic", "", "p", NULL,
	  G_CALLBACK (ev_window_cmd_go_previous_page) },
	{ "n", "go-down-symbolic", "", "n", NULL,
	  G_CALLBACK (ev_window_cmd_go_next_page) },
        { "Plus", "zoom-in-symbolic", NULL, "plus", NULL,
          G_CALLBACK (ev_window_cmd_view_zoom_in) },
        { "CtrlEqual", "zoom-in-symbolic", NULL, "<control>equal", NULL,
          G_CALLBACK (ev_window_cmd_view_zoom_in) },
        { "Equal", "zoom-in-symbolic", NULL, "equal", NULL,
          G_CALLBACK (ev_window_cmd_view_zoom_in) },
        { "Minus", "zoom-out-symbolic", NULL, "minus", NULL,
          G_CALLBACK (ev_window_cmd_view_zoom_out) },
        ...
        { "KpPlus", "zoom-in-symbolic", NULL, "KP_Add", NULL,
          G_CALLBACK (ev_window_cmd_view_zoom_in) },
        { "KpMinus", "zoom-out-symbolic", NULL, "KP_Subtract", NULL,
          G_CALLBACK (ev_window_cmd_view_zoom_out) },
        { "CtrlKpPlus", "zoom-in-symbolic", NULL, "<control>KP_Add", NULL,
          G_CALLBACK (ev_window_cmd_view_zoom_in) },
        { "CtrlKpMinus", "zoom-out-symbolic", NULL, "<control>KP_Subtract", NULL,
          G_CALLBACK (ev_window_cmd_view_zoom_out) },
	{ "CtrlInsert", "edit-copy-symbolic", NULL, "<control>Insert", NULL,
	  G_CALLBACK (ev_window_cmd_edit_copy) },
};
...
static const GtkToggleActionEntry toggle_entries[] = {
	...
	{ "ViewToolbar", NULL, N_("_Toolbar"), NULL,
	  ...
	  G_CALLBACK (ev_window_view_toolbar_cb), TRUE },
        { "ViewSidebar", "document-properties-symbolic", N_("Side _Pane"), "F9",
	  N_("Show or hide the side pane"),
	  G_CALLBACK (ev_window_view_sidebar_cb), TRUE },
        { "ViewContinuous", "view-paged-symbolic", N_("_Continuous"), NULL,
	  N_("Show the entire document"),
	  G_CALLBACK (ev_window_cmd_continuous), TRUE },
        { "ViewDual", "view-dual-symbolic", N_("_Dual"), NULL,
	  ...
	  G_CALLBACK (ev_window_cmd_dual), FALSE },
        ...
        { "ViewPageWidth", "zoom-original-symbolic", N_("Fit Page _Width"), NULL,
