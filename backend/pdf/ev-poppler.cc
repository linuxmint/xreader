					 ...
					 EvRectangle           *rect)
{
	...
	switch (ev_annotation_get_annotation_type (annot)) {
		...
		case EV_ANNOTATION_TYPE_CIRCLE:
			...
			break;
		case EV_ANNOTATION_TYPE_LINE: {

			EvAnnotationLine   *line = EV_ANNOTATION_LINE (annot);
			...
			poppler_annot = poppler_annot_line_new (pdf_document->document, &poppler_rect, &start, &end);
			}
			break;
